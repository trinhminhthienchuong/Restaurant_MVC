                ...
                <div class="header-main">
                    <div class="container">
                        ...
                        <div class="header-logo">
                            <a href="index.html" class="logo logo-static"><img src="public/assets/images/logo-white.png" alt="fooday" class="logo-img"></a>
                            <a href="index.html" class="logo logo-fixed"><img src="public/assets/images/logo.png" alt="fooday" class="logo-img"></a>
                        </div>
                        ...
                        <nav id="main-nav-offcanvas" class="main-nav-wrapper">
                            ...
                            <div class="main-nav">
                                <ul id="main-nav" class="nav nav-pills">
                                    ...
                                    <li><a href="listMenu.php">Thực đơn</a></li>
                                    <li><a href="seasonalFood.php">Món ăn theo mùa</a></li>
                                    ...
                                    <div class="ft-widget-area">
                                        <div class="ft-area1">
                                            <div class="swin-wget swin-wget-about">
                                                <div class="clearfix">
                                                    <a class="wget-logo"><img src="public/assets/images/logo-ft.png" alt="" class="img img-responsive"></a>
